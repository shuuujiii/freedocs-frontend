                    ...
                    <Paper className={classes.paper}>
                        <Typography style={{ textAlign: 'left' }}>
                            ...
                            <div>
                                ...
                                <h2>(3)ユーザーが本サービスを利用するにあたって、{defineWords.me}が収集する情報</h2>
                                <div>
                            ...
                            <div>
                                本サービスのサービス提供にかかわる利用者情報の具体的な利用目的は以下のとおりです。<br />
                                    ...
                                    (5)	本サービスに関する{defineWords.me}の規約、ポリシー等（以下「規約等」といいます。）に違反する行為に対する対応のため<br />
                                    (6)	本サービスに関する規約等の変更などを通知するため<br />
                            </div>
                            <h1>3. 通知・公表または同意取得の方法、利用中止要請の方法</h1>
                            <div>
                                3-1	以下の利用者情報については、その収集が行われる前にユーザーの同意を得るものとします<br />
                                位置情報<br />
                                3-2	ユーザーは、本サービスの所定の設定を行うことにより、利用者情報の全部または一部についてその収集又は利用の停止を求めることができ、<br />
